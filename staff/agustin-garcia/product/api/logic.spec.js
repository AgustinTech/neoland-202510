...
describe('logic', () => {
    ...
    describe('changeEmail', () => {
        it('succeeds on existing user', () => {
            return data.insertUser(new UserData(null, 'Mi Ke', 'mi@ke.com', 'mike', hashed, null, 'regular'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => logic.changeEmail(userData.id, 'mi@ke.com', 'mi@ke2.com', 'mi@ke2.com'))
        ...
        it('fails on non-existing user', () => {
            ...
            return logic.changeEmail('012345678901234567890123', 'mi@ke.com', 'mi@ke2.com', 'mi@ke2.com')
                .catch(error => caught = error)
                .finally(() => {
                    expect(caught).to.be.instanceOf(ExistenceError)
                    expect(caught.message).to.equal('user not found')
        ...
        it('fails on wrong email', () => {
            ...
            return data.insertUser(new UserData(null, 'Mi Ke', 'mi@ke.com', 'mike', hashed, null, 'regular'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => logic.changeEmail(userData.id, 'mi@ke3.com', 'mi@ke2.com', 'mi@ke2.com'))
                .catch(error => caught = error)
                .finally(() => {
    ...
    describe('changePassword', () => {
        it('succeeds on existing user', () => {
            return data.insertUser(new UserData(null, 'Mi Ke', 'mi@ke.com', 'mike', hashed, null, 'regular'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => logic.changePassword(userData.id, '123123123', '234234234', '234234234'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => {
                    expect(userData.name).to.equal('Mi Ke')
                    expect(userData.email).to.equal('mi@ke.com')
        ...
        it('fails on non-existing user', () => {
            ...
            return logic.changePassword('012345678901234567890123', '123123123', '234234234', '234234234')
                .catch(error => caught = error)
                .finally(() => {
                    expect(caught).to.be.instanceOf(ExistenceError)
                    expect(caught.message).to.equal('user not found')
        ...
        it('fails on wrong password', () => {
            ...
            return data.insertUser(new UserData(null, 'Mi Ke', 'mi@ke.com', 'mike', hashed, null, 'regular'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => logic.changePassword(userData.id, '123123123_', '234234234', '234234234'))
                .catch(error => caught = error)
                .finally(() => {
                    expect(caught).to.be.instanceOf(CredentialError)
                    expect(caught.message).to.equal('incorrect password')
    ...
    describe('changeUsername', () => {
        it('succeeds on existing user', () => {
            return data.insertUser(new UserData(null, 'Mi Ke', 'mi@ke.com', 'mike', hashed, null, 'regular'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => logic.changeUsername(userData.id, 'mike2'))
                .then(() => data.findUserByEmail('mi@ke.com'))
                .then(userData => {
                    expect(userData.name).to.equal('Mi Ke')
                    expect(userData.email).to.equal('mi@ke.com')
        ...
        it('fails on non-existing user', () => {
            ...
            return logic.changeUsername('012345678901234567890123', 'mike2')
                .catch(error => caught = error)
                .finally(() => {
                    expect(caught).to.be.instanceOf(ExistenceError)
                    expect(caught.message).to.equal('user not found')
