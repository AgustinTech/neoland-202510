...
let wendy = new StraightWoman('Wendy', 22)
let peter = new Man('Peter', 23)
let petra = new Trans('Petra', 23, 'male', true)
let wendu = new Trans('Wendy', 22, 'female', false)
let campa = new Lesbian('Campa', 19)
let pepito = new Gay('Pepito', 40)

console.log('wendy')
console.log('is woman', wendy instanceof Woman)
console.log('is man', wendy instanceof Man)
console.log('is person', wendy instanceof Person)

console.log('peter')
console.log('is woman', peter instanceof Woman)
console.log('is man', peter instanceof Man)
console.log('is person', peter instanceof Person)

console.log('petra')
console.log('is woman', petra instanceof Woman)
console.log('is man', petra instanceof Man)
console.log('is person', petra instanceof Person)
console.log('is trans', petra instanceof Trans)

console.log('wendy')
console.log('is woman', wendu instanceof Woman)
console.log('is man', wendu instanceof Man)
console.log('is person', wendu instanceof Person)
console.log('is trans', wendu instanceof Trans)